...
export const CONTRACT_ADDRESSES = {
  RENT_TOKEN: (process.env.NEXT_PUBLIC_RENT_TOKEN_ADDRESS || '0x6e7474081a324eef988b7390354a15ec317be34f') as `0x${string}`,
  ...
  SYSTEM_WALLET: (process.env.NEXT_PUBLIC_SYSTEM_WALLET_ADDRESS || '0x6e7474081a324eef988b7390354a15ec317be34f') as `0x${string}`,
};
